...
public class JSONValue {
    ...
    public static void writeJSONString(Object value, Writer out, boolean flush) throws IOException {
        if (value == null) {
            out.write("null");
            ...
            if (value instanceof Number) {
                ...
                ((JSONStreamAware)value).writeJSONString(out, flush);
            } else if (value instanceof JSONAware) {
                out.write(((JSONAware)value).toJSONString());
            } else if (value instanceof Map) {
                JSONObject.writeJSONString((Map)value, out, flush);
            } else if (value instanceof List) {
                JSONArray.writeJSONString((List)value, out, flush);
            } else {
                out.write(value.toString());
            }
        } else {
